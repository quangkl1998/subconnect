...
import { ChainDataContext, ClientContext, IFormattedRpcResponse, JsonRpcContext } from "../contexts";
...
export function JsonRpcContextProvider({
  ...
  const { client, session, accounts, balances, solanaPublicKeys } = useContext(ClientContext);
