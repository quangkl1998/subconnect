...
import { ClientContext, ModalType, ModalWalletConnectContext } from "../contexts";
...
const web3Modal = new Web3Modal({
  projectId: 'fc9c8c192aa65fef298a9b792e23ee2c',
  themeMode: "light",
...
export function ClientContextProvider({
  ...
  return (
    ...
    >
      <ModalWalletConnectContext.Provider value={modalInfo}>
        {children}
      </ModalWalletConnectContext.Provider>
    </ClientContext.Provider>
  );
}
